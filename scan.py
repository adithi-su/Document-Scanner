...
# load image, compute ratio of old to new height,clone and resize inorder to speed up image processing
...
gray = cv2.GaussianBlur(gray, (5,5), 0)  # to remove high frequency noise
